...
def wsgi_app(environ, start_response):
    ...
    try:
        ...
        if handler:
            ...
            # Check if this path is a file or a directory. If it is a directory,
            # and there is an index.html file inside, we send the index.html
            # file instead.
            if os.path.isdir(file_path):
                if file_path[-1] is os.sep and os.path.isfile(file_path + os.sep + 'index.html'):
